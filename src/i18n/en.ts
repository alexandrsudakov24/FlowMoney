const en = {
    ...
    receipt_scan_hint: 'Take a photo — AI fills in the amount, date and category',
    receipt_will_add: 'This expense will be added:',
    receipt_add: 'Add',
    receipt_edit: 'Edit',
    receipt_not_recognized: "Couldn't find a receipt total in this photo. Try a clearer shot.",
    receipt_error_rate_limited: 'Too many requests. Please try again in a bit.',
    receipt_error_blocked: "The AI couldn't read this image. Try another photo.",
    receipt_error_parse_error: 'Something went wrong reading the receipt. Please try again.',
    receipt_error_network_error: 'The AI service is temporarily unavailable. Please try again later.',
    receipt_error_no_api_key: 'Receipt scanning is not configured.',
    receipt_error_invalid_api_key: 'Receipt scanning is unavailable because the API key is invalid or not enabled.',
