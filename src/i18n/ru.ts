...
const ru: Record<TranslationKeys, string> = {
    ...
    receipt_scan: 'Сканировать чек',
    receipt_scanning: 'Читаю чек…',
    receipt_scan_hint: 'Сфотографируйте — AI заполнит сумму, дату и категорию',
    receipt_will_add: 'Будет добавлен расход:',
    receipt_add: 'Добавить',
    receipt_edit: 'Изменить',
    receipt_not_recognized: 'Не удалось найти сумму чека на фото. Попробуйте снять чётче.',
    receipt_error_rate_limited: 'Слишком много запросов. Попробуйте чуть позже.',
    receipt_error_blocked: 'AI не смог прочитать это изображение. Попробуйте другое фото.',
    receipt_error_parse_error: 'Не удалось распознать чек. Попробуйте ещё раз.',
    receipt_error_network_error: 'AI-сервис временно недоступен. Попробуйте позже.',
    receipt_error_no_api_key: 'Сканирование чеков не настроено.',
    receipt_error_invalid_api_key: 'Сканирование чеков недоступно: API-ключ неверен или не активирован.',
