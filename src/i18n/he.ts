...
const he: Record<TranslationKeys, string> = {
    ...
    receipt_scan: 'סריקת קבלה',
    receipt_scanning: 'קורא את הקבלה…',
    receipt_scan_hint: 'צלמו — ה-AI ימלא סכום, תאריך וקטגוריה',
    receipt_will_add: 'ההוצאה הבאה תתווסף:',
    receipt_add: 'הוסף',
    receipt_edit: 'ערוך',
    receipt_not_recognized: 'לא נמצא סכום קבלה בתמונה. נסו צילום ברור יותר.',
    receipt_error_rate_limited: 'יותר מדי בקשות. נסו שוב בעוד רגע.',
    receipt_error_blocked: 'ה-AI לא הצליח לקרוא את התמונה. נסו תמונה אחרת.',
    receipt_error_parse_error: 'משהו השתבש בקריאת הקבלה. נסו שוב.',
    receipt_error_network_error: 'שירות ה-AI אינו זמין כרגע. נסו שוב מאוחר יותר.',
    receipt_error_no_api_key: 'סריקת קבלות אינה מוגדרת.',
    receipt_error_invalid_api_key: 'סריקת קבלות אינה זמינה כי מפתח ה-API שגוי או לא מופעל.',
